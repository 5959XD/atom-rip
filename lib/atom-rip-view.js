...
export default class AtomRipView {
  constructor () {
    ...
    this.subscription.add(atom.config.observe('atom-rip.restTime', time => this.restTime = time))
  ...
  initElement () {
    ...
    this.subscription.add(atom.config.observe('atom-rip.customFont', font => this.element.style.fontFamily = font))
