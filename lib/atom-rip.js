...
export default {
  activate () {
    ...
    this.subscription.add(atom.config.observe('atom-rip.codingTime', time => {
      this.codingTime = time
      if (this.timerView) this.timerView.update(this.time = this.codingTime)
    }))
